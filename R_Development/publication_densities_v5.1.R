...
ggsave(paste("graphics/density_", modelVersion, "_facets_O.png"), plot = combined_plot, dpi=300, width = 8, height = 4)

combined_plot <-  (plots[[5]] | plots[[6]] | plots[[7]] | plots[[8]])
ggsave(paste("graphics/density_", modelVersion, "_facets_C.png"), plot = combined_plot, dpi=300, width = 8, height = 4)

combined_plot <-  (plots[[9]] | plots[[10]] | plots[[11]] | plots[[12]])
ggsave(paste("graphics/density_", modelVersion, "_facets_E.png"), plot = combined_plot, dpi=300, width = 8, height = 4)

combined_plot <- (plots[[13]] | plots[[14]] | plots[[15]] | plots[[16]])
ggsave(paste("graphics/density_", modelVersion, "_facets_A.png"), plot = combined_plot, dpi=300, width = 8, height = 4)

combined_plot <- (plots[[17]] | plots[[18]] | plots[[19]])
ggsave(paste("graphics/density_", modelVersion, "_facets_N.png"), plot = combined_plot, dpi=300, width = 8, height = 4)
...
psych_table
save_as_docx(psych_table, path = paste("tables/desc_", modelVersion, "_facets.docx"))
