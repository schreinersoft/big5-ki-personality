...
png(paste("graphics/corrplot_", measurement_version, "_facets.png"), width = 2400, height = 2400, res = 150)
...
# Plot correlation Matrix
png(paste("graphics/corrplot_spearman_", measurement_version, "_facets.png"), width = 2400, height = 2400, res = 150)
corrplot(cor_matrix_rounded, method = "color", type = "upper", 
         addCoef.col = "black", tl.cex = 0.8)
dev.off()
...
# Plot correlation Matrix
png(paste("graphics/corrplot_", measurement_version, "_factors.png"), width = 2400, height = 2400, res = 150)
corrplot(cor_matrix_rounded, method = "color", type = "upper", 
         addCoef.col = "black", tl.cex = 0.8)
dev.off()
...
ft <- flextable(fit_data) %>%
  ...
  width(j = 2, width = 1) %>%
  width(j = 3, width = 1.8)
save_as_docx(ft, path = paste("tables/measures_", measurement_version, ".docx"))
...
save_as_docx(ft, path = paste("tables/loadings_", measurement_version, ".docx"))
...
ggsave(paste("graphics/screeplot_" , measurement_version, ".png"), plot = screePlot, dpi=300, width = 8, height = 5)
