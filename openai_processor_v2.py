...
def process_openai_v2(batch_size: int, max_num: int, repeats: int=2, service_tier: str = "flex", temperature: int = 0.0):
...
if __name__ == "__main__":
    process_openai_v2(5, 50, repeats=5) #, service_tier="default")
