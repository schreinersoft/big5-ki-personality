            ...
            for entry in entries:
                ...
                try:
                    for repeat in range(repeats):
                        ...
                        response, result = openai_classifier.classify(input_text=entry.text or entry.text_raw, system_prompt=system_prompt, temperature=0.0, service_tier=service_tier)
                    ...
                    i += 1
                    if exc_counter > 50:
                        raise("Excepetion Counter exceeded 50!")
                        


                
if __name__ == "__main__":
    process_openai_corpus(max_entries=1000, repeats=3)
