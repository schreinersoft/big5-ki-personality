...
def parse_letters_from_pdf(pdf_path):
    """
...
if __name__ == "__main__":
    ...
    if letters:
        ...
        try:
            with open("extracted_letters.json", "w", encoding="utf-8") as f:
                json.dump(letters, f, indent=4, ensure_ascii=False)
            print("Successfully saved extracted data to extracted_letters.json")
        except Exception as e:
